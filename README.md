...
<div style="display: flex; justify-content: center;">
  <figure style="text-align: center; margin: 10px;">
    ...
    <figcaption style="font-style: italic;">Touch Switch de chez Rang Dong</figcaption>
  </figure>
</div>
...
<div style="display: flex; justify-content: center;">
  <figure style="text-align: center; margin: 10px;">
    ...
    <figcaption style="font-style: italic;">Proposition 1 pour l'alim AC</figcaption>
  </figure>
  <figure style="text-align: center; margin: 10px;">
    <img src="Media/ac_input_schem_2.png" alt="AC_input_schem2" width="400"/>
    <figcaption style="font-style: italic;">Proposition 2 pour l'alim AC</figcaption>
  </figure>
</div>
